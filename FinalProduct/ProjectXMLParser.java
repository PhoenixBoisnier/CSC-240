...
//  private ArrayList<Creature> creatureBuffer = new ArrayList<>();
    private BST<Creature> creatureBuffer = new BST<>();
	...
	public void startElement(String namespaceURI, String localName, String qName, Attributes atts) throws SAXException {
		...
		if(qName.equals("animal")) {
			creatureBuffer.insert(new Animal(atts.getValue("name"),atts.getValue("description")));	
		}
		if(qName.equals("NPC")) {
			creatureBuffer.insert(new NPC(atts.getValue("name"),atts.getValue("description")));
		}
		if(qName.equals("PC")) {
			creatureBuffer.insert(new PC(atts.getValue("name"),atts.getValue("description")));
		}
    }
