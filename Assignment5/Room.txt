...
//	private Creature[] roomContents = new Creature[10];
	private LinkedList<Creature> roomContents = new LinkedList<>();
	 ...
	 */
	public void setContents(LinkedList<Creature> input) {
		roomContents = input;
	}
	 ...
	 */
	public LinkedList<Creature> getList() {
		return roomContents;
	}
