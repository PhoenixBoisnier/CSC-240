...
//  private ArrayList<Creature> creatureBuffer = new ArrayList<>();
    private LinkedList<Creature> creatureBuffer = new LinkedList<>();
	...
	public void startElement(String namespaceURI, String localName, String qName, Attributes atts) throws SAXException {
		...
		if(qName.equals("animal")) {
			creatureBuffer.append(new Animal(atts.getValue("name"),atts.getValue("description")));	
		}
		if(qName.equals("NPC")) {
			creatureBuffer.append(new NPC(atts.getValue("name"),atts.getValue("description")));
		}
		if(qName.equals("PC")) {
			creatureBuffer.append(new PC(atts.getValue("name"),atts.getValue("description")));
		}
    }
    ...
    public void endElement(String namespaceURI, String localName, String qName) throws SAXException {
        ...
        if(qName.equals("room")) {
        	...
        	roomBuffer.setContents(creatureBuffer);
        	for(Creature c: roomBuffer.getList()) {
        		c.setRoom(roomBuffer);
        	}
        	System.out.println("Room after creatures: "+roomBuffer.toString());
